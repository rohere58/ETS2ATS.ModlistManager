...
> Hinweis/Notice: Aktuelle Version 0.1.18.1 enthält einen Hotfix für die Erkennbarkeit fehlender Download-Links im Mod-Grid.
> Current version 0.1.18.1 includes a hotfix to make missing download links in the mods grid immediately visible.
> Downloads:
> - Multi-File (empfohlen / recommended): https://github.com/rohere58/ETS2ATS.ModlistManager/releases/download/v0.1.18.1/modlist-manager-0.1.18.1-win-x64.zip
> - Single-File (kompakte Einzel-EXE): https://github.com/rohere58/ETS2ATS.ModlistManager/releases/download/v0.1.18.1/modlist-manager-0.1.18.1-self-contained-win-x64.zip
...
1. Release (ZIP) herunterladen:
  - Empfohlen (enthält Tools-Ordner direkt): [Multi-File v0.1.18.1](https://github.com/rohere58/ETS2ATS.ModlistManager/releases/download/v0.1.18.1/modlist-manager-0.1.18.1-win-x64.zip)
  - Alternative (eine einzelne EXE): [Single-File v0.1.18.1](https://github.com/rohere58/ETS2ATS.ModlistManager/releases/download/v0.1.18.1/modlist-manager-0.1.18.1-self-contained-win-x64.zip)
...
```powershell
# Beispiel für v0.1.18.1 (Dateien aus dem GitHub Release herunterladen)
Get-FileHash .\modlist-manager-0.1.18.1-win-x64.zip -Algorithm SHA256
Get-Content .\modlist-manager-0.1.18.1-win-x64.zip.sha256
```
...
pwsh ./build-release.ps1 -Version 0.1.18.1 -SingleFile:$true

# Multi-File (mit Tools-Ordner)
pwsh ./build-release.ps1 -Version 0.1.18.1 -SingleFile:$false
```
...
1. Download release (ZIP):
  - Recommended (includes Tools folder with SII_Decrypt.exe): [Multi-File v0.1.18.1](https://github.com/rohere58/ETS2ATS.ModlistManager/releases/download/v0.1.18.1/modlist-manager-0.1.18.1-win-x64.zip)
  - Alternative (single executable): [Single-File v0.1.18.1](https://github.com/rohere58/ETS2ATS.ModlistManager/releases/download/v0.1.18.1/modlist-manager-0.1.18.1-self-contained-win-x64.zip)
