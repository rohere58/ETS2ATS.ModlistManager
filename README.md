...
> Hinweis/Notice: Aktuelle Version 0.1.18 enthält Verbesserungen im Mod-Grid (Status/Download/Workshop) inkl. Lokalisierungs-Fixes.
> Current version 0.1.18 includes mods grid improvements (status/download/Workshop) plus localization fixes.
> Downloads:
> - Multi-File (empfohlen / recommended): https://github.com/rohere58/ETS2ATS.ModlistManager/releases/download/v0.1.18/modlist-manager-0.1.18-win-x64.zip
> - Single-File (kompakte Einzel-EXE): https://github.com/rohere58/ETS2ATS.ModlistManager/releases/download/v0.1.18/modlist-manager-0.1.18-self-contained-win-x64.zip
...
1. Release (ZIP) herunterladen:
  - Empfohlen (enthält Tools-Ordner direkt): [Multi-File v0.1.18](https://github.com/rohere58/ETS2ATS.ModlistManager/releases/download/v0.1.18/modlist-manager-0.1.18-win-x64.zip)
  - Alternative (eine einzelne EXE): [Single-File v0.1.18](https://github.com/rohere58/ETS2ATS.ModlistManager/releases/download/v0.1.18/modlist-manager-0.1.18-self-contained-win-x64.zip)
...
```powershell
# Beispiel für v0.1.18 (Dateien aus dem GitHub Release herunterladen)
Get-FileHash .\modlist-manager-0.1.18-win-x64.zip -Algorithm SHA256
Get-Content .\modlist-manager-0.1.18-win-x64.zip.sha256
```
...
pwsh ./build-release.ps1 -Version 0.1.18 -SingleFile:$true

# Multi-File (mit Tools-Ordner)
pwsh ./build-release.ps1 -Version 0.1.18 -SingleFile:$false
```
...
1. Download release (ZIP):
  - Recommended (includes Tools folder with SII_Decrypt.exe): [Multi-File v0.1.18](https://github.com/rohere58/ETS2ATS.ModlistManager/releases/download/v0.1.18/modlist-manager-0.1.18-win-x64.zip)
  - Alternative (single executable): [Single-File v0.1.18](https://github.com/rohere58/ETS2ATS.ModlistManager/releases/download/v0.1.18/modlist-manager-0.1.18-self-contained-win-x64.zip)
